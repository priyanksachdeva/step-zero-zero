...
import {
  IntelligentGoalManager,
  GoalProgress,
  GoalRecommendation,
} from "../lib/goalManager";
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-right">
            ...
            <div className="tech-label">
              OF {goalProgress.target.toLocaleString()}
            </div>
          </div>
        </div>
        ...
        <div className="glass p-4">
          {weeklyData.map((day, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`font-technical text-xs w-8 ${
      ...
      {recommendation && recommendation.adjustmentType !== "maintain" && (
        <div className="glass-medium p-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="tech-label text-accent mb-2">
                GOAL RECOMMENDATION
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div>
                  ...
                  <span className="font-display">
                    {recommendation.currentGoal.toLocaleString()}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span className="font-display text-accent">
                    {recommendation.recommendedGoal.toLocaleString()}
                  </span>
                </div>
              </div>
